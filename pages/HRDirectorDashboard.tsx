...
const sidebarGroups: SidebarGroup[] = [
  {
    ...
    links: [
      ...
      { label: "Unit Users", href: "#users", icon: Users },
    ...
    <>
      <section className="dashboard-card-grid">
        ...
        <OverviewShortcutCard
          ...
          onClick={() => setActiveSection("users")}
          className={pendingUsersCount > 0 ? "featured-metric-card" : ""}
          kicker="Approval"
        />
        <OverviewShortcutCard
          title="Create User"
        ...
        <OverviewShortcutCard
          ...
          kicker="Workflow"
          className={pendingWorkflowApprovals.length > 0 ? "featured-metric-card" : ""}
        />
        <OverviewShortcutCard
